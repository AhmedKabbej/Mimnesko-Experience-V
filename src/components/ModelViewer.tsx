  ...
  useLayoutEffect(() => {
    ...
    g.traverse((o) => {
      if ((o as THREE.Mesh).isMesh) {
        ...
        if (fadeIn) {
          ;(o as THREE.Mesh).material = ((o as THREE.Mesh).material as THREE.MeshStandardMaterial).clone()
          ;((o as THREE.Mesh).material as THREE.MeshStandardMaterial).transparent = true
          ;((o as THREE.Mesh).material as THREE.MeshStandardMaterial).opacity = 0
        }
      }
    })
    ...
    if (fadeIn) {
      ...
      const id = setInterval(() => {
        ...
        g.traverse((o) => {
          if ((o as THREE.Mesh).isMesh)
            ((o as THREE.Mesh).material as THREE.MeshStandardMaterial).opacity = v
        })
        invalidate()
        if (v === 1) {
          clearInterval(id)
